...
- Unterscheidung von
  ...
  - "implementation-defined behaviour"
    ...
    - z.B. konkrete Größen der Basisdatentypen

# Grundlegende Datentypen

Integer
- Diese Datantypen zur Darstellung von ganzen Zahlen
![image1](afa8ec8f66164c7180387122ffa62c50.png)

- char per Def 1 Byte, alle anderenGrößen von Datentypen sind implementierungsabhängig

- Datentypen standardmäßen vorzeichenbehaftet
...
- Wird einem \_Bool ein Wert != 0 zugewiesen, wird dieser Wert automatisch zu 1 konvertiert
...
Void
- Leerer Datentyp
- "kein Rpckgabewert" oder "keine Parameter"
...
- ![image4](feeb7b6c2aca4947a0ef8f1e2c4d9511.png)
...
- Rückgabewerte
  - Standardisierte Konstanten EXIT_SUCCESS und EXIT_FAILURE
    - -\> unabhängig der Impl
  - Ansonsten 0 für success, 1 für allgemeiner Fehlercode, anderer kleiner Integer der je nach Kontext eine bestimmt Bedeutung haben kann
...
Scopes
- ![image6](4d31830adde5438f81b5c979c3c4667a.png)
...
- && gibt immer int zurück mit entweder 0 oder 1
...
- \<\> if lib is from C standard lib
- "" if it's from own proj

# Header-Dateien
- ![image14](b8ec6bb3766c47e6a9fc25869b9e9787.png)
...
- Storage class specifier static & extern
  ...
  - Static ~ private
- ![image15](7fa8c13233c74816b78f23418e143a17.png)
...
- stdint.h
  ...
  - Definiert fixed-width Integer Typen
    ...
    - -\> mehr Kontrolle
  - ![image17](666ffa2603fc4389aecf660c1cd453f4.png)
